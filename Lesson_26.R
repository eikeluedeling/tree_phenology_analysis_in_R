...
# example of where we're not allowed to make predictions
require(ggplot2)
...
# preparing data for validity domain mapping
...
# restricting this to the dormancy months
...
# adding the experimentally enhanced data
