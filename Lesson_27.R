...
# running PhenoFlex with default parameters
yc <- 40
zc <- 190
...
# exploring results - chill and heat accumulation
...
# making this into a loop, so that we can run this for multiple seasons
...
# Now we parameterize the model for Alexander Lucas pears
...
# we have to set initial values for the parameters
...
# running the solver to find optimal parameter values
